...
<button type="button"  onclick="color2(['red','green', 'yellow']);" class="btn btn-light">Включить </button>
<button type="button" class="btn btn-primary">Выключить</button>
